        ...
        users.forEach(user => {
          ...
          if (dayAttendance) {
            attendances[user.employeeNumber] = {
              present: true,
              type: dayAttendance.isFullDay ? 'FULL_DAY' : 
                    dayAttendance.isHalfDay ? 'HALF_DAY' : 'IN_PROGRESS',
  ...
  return (
    <div className="calendar">
      <div className="calendar-header">
        <h2>{new Date(year, month - 1).toLocaleDateString('en-US', { 
          month: 'long', 
          year: 'numeric' 
        })}</h2>
